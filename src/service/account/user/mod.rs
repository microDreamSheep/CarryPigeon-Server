...
user_name:注册的用户名
 */
pub async fn is_user_name_contained_service(user_name: &str) -> bool {
 ...
 */
pub async fn user_register_service(user_info: UserRegisterDTO) -> Result<String, String> {
 ...
 */
pub async fn push_user_service(user: User, sender: Arc<Mutex<CPSender>>, token: String) {
    // 对stream进行包装
